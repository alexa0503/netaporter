var shareData = {
    img_url		: "http://virgo.socialfishface.com/images/shareImg.jpg",
    site_link	: 'http://virgo.socialfishface.com/',
    messageDesc	: '参加完某位处女座的13岁生日趴 我整整回味了3天3夜',
	circleDesc	: '参加完某位处女座的13岁生日趴 我整整回味了3天3夜',
    title		: '处女座生日趴',
	backFun		: '',
	cancelFun	: ''
};
...
$.ajax({
	type	: "post",
	url		: 'http://zinai.jweishang.com/api.aspx',
	dataType: "text",
	data	:{
				type	: "signature",
	...
	success	:function(result)
			{
				...
				wx.config(
				{
					...
					appId		: 'wxbf6c0e2ba3b072b4', // 必填，公众号的唯一标识
